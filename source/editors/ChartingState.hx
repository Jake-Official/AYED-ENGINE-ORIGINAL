...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['soul-out', "Not Needed For Other Week It's For Only Canell-really song \nbtw it's soul out event"],
		...
		['cold-Taste-Art', "just put it and your good okay ?"],
		['shaderHeartburn', "Value 1: That Value will be bool BUT WARNING THAT FOR ONLY HEARTBURN_BG\n(true = set shader) - (false = delete shader)"],
		['pauseVocal', "made that for tiktok video so fuck you !"],
		['textLyrics', "Value 1: Put The Text Will Type In Screen \nValue 2: just put it blank BUT \nif the value1 is blank and value 2 has 'skipDialogue' it will skip the dialogue"]
	];
	...
	**/
	...
	override function create()
	{
		...
		// what the game that you put on game like side ---... FlxG.sound.play(Paths.sound("YourSound"));

		// what the sigma 

		// in game that you made is always peak not like me...

		// so set camera as 100% --- which is mean alpha of camera...
