...
class LoadingState extends MusicBeatState
{
	...
	override function create()
	{
		...
		LoadingAyedEngine = new FlxSprite(0, 0).loadGraphic(Paths.image('LoadingBG/LoadingAyedEngine' + FlxG.random.int(1, 6)));
		...
		if(!ClientPrefs.hideLoadingState){
			LoadingAyedEngine.visible = true;
		}else{
			LoadingAyedEngine.visible = false;
		}

		loadBar = new FlxSprite(0, FlxG.height - 20).makeGraphic(FlxG.width, 10, 0xff04eeff);
