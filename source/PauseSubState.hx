...
{
	public static var backSong:Bool = false;
	...
	public function new(x:Float, y:Float)
	{
		...
		var artist:FlxText = new FlxText(20, 15 + 32, 0, "", 32);
		artist.text += "Artist: " + PlayState.SONG.artist;
		artist.scrollFactor.set();
		artist.setFormat(Paths.font('vcr.ttf'), 32);
		artist.updateHitbox();
		add(artist);

		var levelDifficulty:FlxText = new FlxText(20, 15 + 100, 0, "", 32);
		...
		var blueballedTxt:FlxText = new FlxText(20, 15 + 132, 0, "", 32);
		...
		var chartingText:FlxText = new FlxText(20, 15 + 192, 0, "CHARTING MODE", 32);
