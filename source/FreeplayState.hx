...
{
	public static var coverAlbum:String = ""; //wdym by v-slice stfu it's for songs version ost
	...
	override function create()
	{
		...
		bg = new FlxSprite();
		bg.loadGraphic(Paths.image('artMainMenuBg/menuFreeplay'));
