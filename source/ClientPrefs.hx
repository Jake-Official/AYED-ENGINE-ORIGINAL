...
class ClientPrefs {
	public static var hasBeated:Bool;
	...
	public static var hideLoadingState:Bool = true;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.hasBeated = hasBeated;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.hasBeated != null){
			hasBeated = FlxG.save.data.hasBeated;
		}
