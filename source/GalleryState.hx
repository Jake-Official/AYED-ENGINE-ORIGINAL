...
{
    var itemsShits:Array<String> = ["Ayed", "Bamibo", "Pico", "Boyfriend", "Girlfriend"];
    ...
    override function create()
    {
        ...
        gallerywel = new FlxText(0, 0, 0, 'Version Engine : ' + MainMenuState.ayedEngineVersion, 30);
